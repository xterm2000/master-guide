...
| `network/` | Networking concepts + planning + diagnostics method, small network-tool reference + dispatch table, DNS, iptables, connectivity diagnostics | [`network/README.md`](network/README.md) |
